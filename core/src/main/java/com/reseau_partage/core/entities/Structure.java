...
public abstract class Structure {
    ...
    @Column(name = "date_debut_vide")
    private LocalDateTime dateDebutVide;
    ...
    public void setSuperficieM2(BigDecimal v) {
        superficieM2 = v;
    }
    ...
    public StatutStructure getStatut() {
        return statut;
    }

    public void setStatut(StatutStructure v) {
        statut = v;
    }
    ...
    public LocalDateTime getDateDebutVide() {
        return dateDebutVide;
    }

    public void setDateDebutVide(LocalDateTime v) {
        dateDebutVide = v;
    }
}
