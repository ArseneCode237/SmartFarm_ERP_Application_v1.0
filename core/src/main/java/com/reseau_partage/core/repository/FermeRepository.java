...
public interface FermeRepository extends JpaRepository<Ferme,Long> { List<Ferme> findByStatut(StatutFerme statut); boolean existsByNomAndPays(String nom,String pays); }
